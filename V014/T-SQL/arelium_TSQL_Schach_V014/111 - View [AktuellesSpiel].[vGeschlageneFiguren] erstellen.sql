...
-- ###########################################################################################
-- ### Erstellung der Sicht [AktuellesSpiel].[vGeschlageneFiguren]                         ###
-- ### ----------------------------------------------------------------------------------- ###
...
-- Aufbauarbeiten -----------
-----------------------------
CREATE OR ALTER VIEW [AktuellesSpiel].[vGeschlageneFiguren]
AS
...
DECLARE @Skript		VARCHAR(100)	= '111 - Sicht [AktuellesSpiel].[vGeschlageneFiguren] erstellen.sql'
PRINT ' '
PRINT 'Skript     :   ' + @Skript
PRINT 'Ende       :   ' + @Ende
PRINT 'Zeit       :   ' + @Zeit
...
/*
SELECT * FROM [AktuellesSpiel].[vGeschlageneFiguren]
*/