...
-- ###########################################################################################
-- ### Erstellung der Funktion [Infrastruktur].[fncKurzeNotationEinfach]                   ###
-- ### ----------------------------------------------------------------------------------- ###
...
CREATE OR ALTER FUNCTION [Infrastruktur].[fncKurzeNotationEinfach]
(
...
DECLARE @Skript		VARCHAR(100)	= '152 - Funktion [Infrastruktur].[fncKurzeNotationEinfach] erstellen.sql'
PRINT ' '
PRINT 'Skript     :   ' + @Skript
PRINT 'Ende       :   ' + @Ende
PRINT 'Zeit       :   ' + @Zeit
...
GO
/*
-- Test der Funktion [Infrastruktur].[fncKurzeNotationEinfach]

SELECT [Infrastruktur].[fncKurzeNotationEinfach] (13879, 'TRUE', 'FALSE')
GO
*/
