									...
									BEGIN
										...
										BEGIN
											...
											BEGIN
												...
												IF (SELECT [SpielstaerkeID] FROM [Spiel].[Konfiguration] WHERE [IstSpielerWeiss] = ((@IstSpielerWeiss + 1) % 2)) = 1
													AND (SELECT [SpielstaerkeID] FROM [Spiel].[Konfiguration] WHERE [IstSpielerWeiss] = @IstSpielerWeiss) <> 1
												BEGIN
													...
													IF (SELECT [SpielstaerkeID] FROM [Spiel].[Konfiguration] WHERE [IstSpielerWeiss] = @IstSpielerWeiss) = 2				-- zufaelliger Zug
													BEGIN
