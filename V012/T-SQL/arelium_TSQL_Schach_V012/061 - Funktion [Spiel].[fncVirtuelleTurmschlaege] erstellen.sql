...
-- ###########################################################################################
-- ### Erstellung der Funktion [Spiel].[fncVirtuelleTurmschlaege]                          ###
-- ### ----------------------------------------------------------------------------------- ###
-- ### Im Schach gibt es die Fragestellung, ob eine bestimmte Figur (hier der Turm) in     ###
...
CREATE OR ALTER FUNCTION [Spiel].[fncVirtuelleTurmschlaege]
(
...
DECLARE @Skript		VARCHAR(100)	= '061 - Funktion [Spiel].[fncVirtuelleTurmschlaege] erstellen.sql'
PRINT ' '
PRINT 'Skript     :   ' + @Skript
PRINT 'Ende       :   ' + @Ende
PRINT 'Zeit       :   ' + @Zeit
...
GO
/*
-- Test der Funktion [Spiel].[fncVirtuelleTurmschlaege]
...
SELECT * FROM [Spiel].[fncVirtuelleTurmschlaege](
	'TRUE'
	, @ASpielbrett
	, @AktivesFeld
	, 1)
