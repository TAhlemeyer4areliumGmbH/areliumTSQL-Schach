...
-- ###########################################################################################
-- ### Erstellung der Funktion [Spiel].[fncMoeglicheLaeuferaktionen]                       ###
-- ### ----------------------------------------------------------------------------------- ###
...
CREATE OR ALTER FUNCTION [Spiel].[fncMoeglicheLaeuferaktionen]
(
...
DECLARE @Skript		VARCHAR(100)	= '043 - Funktion [Spiel].[fncMoeglicheLaeuferaktionen] erstellen.sql'
PRINT ' '
PRINT 'Skript     :   ' + @Skript
PRINT 'Ende       :   ' + @Ende
PRINT 'Zeit       :   ' + @Zeit
...
GO
/*
-- Test der Funktion [Spiel].[fncMoeglicheLaeuferaktionen]
...
SELECT * FROM [Spiel].[fncMoeglicheLaeuferaktionen] (
	'TRUE'
	, @ASpielbrett
	, @AktivesFeld)
ORDER BY 2,3,4,5,7
