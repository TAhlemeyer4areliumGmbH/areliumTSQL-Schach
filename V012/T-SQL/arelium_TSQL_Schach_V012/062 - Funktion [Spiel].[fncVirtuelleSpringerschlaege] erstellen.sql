...
-- ###########################################################################################
-- ### Erstellung der Funktion [Spiel].[fncVirtuelleSpringerschlaege]                      ###
-- ### ----------------------------------------------------------------------------------- ###
-- ### Im Schach gibt es die Fragestellung, ob eine bestimmte Figur (hier der Springer) in ###
...
CREATE OR ALTER FUNCTION [Spiel].[fncVirtuelleSpringerschlaege]
(
...
DECLARE @Skript		VARCHAR(100)	= '062 - Funktion [Spiel].[fncVirtuelleSpringerschlaege] erstellen.sql'
PRINT ' '
PRINT 'Skript     :   ' + @Skript
PRINT 'Ende       :   ' + @Ende
PRINT 'Zeit       :   ' + @Zeit
...
GO
/*
-- Test der Funktion [Spiel].[fncVirtuelleSpringerschlaege]
...
SELECT * FROM [Spiel].[fncVirtuelleSpringerschlaege](
	'TRUE'
	, @ASpielbrett
	, @AktivesFeld
	, 1)
