...
IF EXISTS
	(
		...
		WHERE [name] = 'arelium_TSQL_Schach_V012'
	)
BEGIN
	ALTER DATABASE [arelium_TSQL_Schach_V012] SET SINGLE_USER WITH ROLLBACK IMMEDIATE
	DROP DATABASE [arelium_TSQL_Schach_V012]
END
...
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET ARITHABORT OFF 
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET AUTO_CREATE_STATISTICS ON(INCREMENTAL = OFF)
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET  DISABLE_BROKER 
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET  READ_WRITE 
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET RECOVERY FULL 
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET  MULTI_USER 
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [arelium_TSQL_Schach_V012] SET DELAYED_DURABILITY = DISABLED 
GO
...
BEGIN
	ALTER DATABASE [arelium_TSQL_Schach_V012] MODIFY FILEGROUP [PRIMARY] DEFAULT
END
GO
...
DECLARE @Skript		VARCHAR(100)	= '001 - Datenbank erstellen.sql'
PRINT ' '
PRINT 'Skript     :   ' + @Skript
PRINT 'Ende       :   ' + @Ende
PRINT 'Zeit       :   ' + @Zeit
