...
-- ###########################################################################################
-- ### Erstellung der Funktion [AktuellesSpiel].[fncMoeglicheLaeuferaktionen]              ###
-- ### ----------------------------------------------------------------------------------- ###
-- ### Moechte man herausfinden, welche Moeglichkeiten man in einer bestimmten Stellung    ###
-- ### hat die Figur "Laeufer" zu ziehen, bemueht man diese Funktion. Sie erwartet die     ###
...
CREATE OR ALTER FUNCTION [AktuellesSpiel].[fncMoeglicheLaeuferaktionen]
(
...
DECLARE @Skript		VARCHAR(100)	= '043 - Funktion [AktuellesSpiel].[fncMoeglicheLaeuferaktionen] erstellen.sql'
PRINT ' '
PRINT 'Skript     :   ' + @Skript
PRINT 'Ende       :   ' + @Ende
PRINT 'Zeit       :   ' + @Zeit
...
GO
/*
-- Test der Funktion [AktuellesSpiel].[fncMoeglicheLaeuferaktionen]
...
SELECT * FROM [AktuellesSpiel].[fncMoeglicheLaeuferaktionen] (
	'TRUE'
	, @ASpielbrett
	, @AktivesFeld)
ORDER BY 2,3,4,5,7
