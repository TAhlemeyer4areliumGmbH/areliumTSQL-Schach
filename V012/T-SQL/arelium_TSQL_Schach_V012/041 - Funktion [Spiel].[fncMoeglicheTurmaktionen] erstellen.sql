...
CREATE OR ALTER FUNCTION [Spiel].[fncMoeglicheTurmaktionen]
(
	...
	BEGIN
		...
		WHERE 1 = 1
			...
			AND [SPB].[FigurUTF8] NOT IN 
				(
					SELECT [FigurUTF8] FROM [Infrastruktur].[Figur]
					WHERE 1 = 1
...
/*
-- Test der Funktion [Spiel].[fncMoeglicheTurmaktionen]
...
SELECT * FROM [Spiel].[fncMoeglicheTurmaktionen] (
	'True'
	, @ASpielbrett
	, @AktivesFeld)
ORDER BY 2,3,4,5,7
