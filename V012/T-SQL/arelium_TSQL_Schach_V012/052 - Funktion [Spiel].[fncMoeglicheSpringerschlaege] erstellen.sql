...
-- ###########################################################################################
-- ### Erstellung der Funktion [Spiel].[fncMoeglicheSpringerschlaege]                      ###
-- ### ----------------------------------------------------------------------------------- ###
-- ### Moechte man herausfinden, welche Moeglichkeiten man in einer bestimmten Stellung    ###
-- ### hat mit der Figur "Springer" zu schlagen, bemueht man diese Funktion. Sie erwartet  ###
...
-- Aufbauarbeiten -----------
-----------------------------
CREATE OR ALTER FUNCTION [Spiel].[fncMoeglicheSpringerschlaege]
(
	   @IstAngreifenderSpielerWeiss		AS BIT
	 , @Bewertungsstellung				AS typStellung			READONLY
	 , @AktivesFeld						AS INTEGER
)
RETURNS @MoeglicheSpringerschlaege TABLE 
	(
	...
	BEGIN
		INSERT INTO @MoeglicheSpringerschlaege
		(
	...
	WHERE 1 = 1
		AND [MZU].[IstSpielerWeiss]				= @IstAngreifenderSpielerWeiss
		AND [MZU].[FigurName]					= 'Springer'
...
DECLARE @Skript		VARCHAR(100)	= '052 - Funktion [Spiel].[fncMoeglicheSpringerschlaege] erstellen.sql'
PRINT ' '
PRINT 'Skript     :   ' + @Skript
PRINT 'Ende       :   ' + @Ende
PRINT 'Zeit       :   ' + @Zeit
...
/*
-- Test der Funktion [Spiel].[fncMoeglicheSpringerschlaege]
...
SELECT * FROM [Spiel].[fncMoeglicheSpringerschlaege] (
	'True'
	, @ASpielbrett
	, @AktivesFeld)
ORDER BY 2,3,4,5,7
