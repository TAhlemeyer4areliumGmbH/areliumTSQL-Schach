...
-- ###########################################################################################
-- ### VIEW [Infrastruktur].[vLogo]                                                        ###
-- ### ----------------------------------------------------------------------------------- ###
-- ### Dieses Skript stellt das Programmlogo dar. Hierzu werden raeumliche Datentypen      ###
-- ### genutzt. Um das Ergebnis richtig darzustellen, ist einfach auf den zusaetzlichen    ###
-- ### Reiter "spatial results" im Ergebnisbereich zu klicken.                             ###
-- ### ----------------------------------------------------------------------------------- ###
-- ### Sicherheitshinweis:                                                                 ###
...
-- Aufbauarbeiten -----------
-----------------------------
CREATE OR ALTER VIEW [Infrastruktur].[vLogo]
AS
	SELECT * FROM [Infrastruktur].[Logo]
GO
...
DECLARE @Skript		VARCHAR(100)	= '118 - View [Infrastruktur].[vLogo] erstellen.sql'
PRINT ' '
PRINT 'Skript     :   ' + @Skript
PRINT 'Ende       :   ' + @Ende
PRINT 'Zeit       :   ' + @Zeit
...
SELECT * FROM [Infrastruktur].[vLogo]
