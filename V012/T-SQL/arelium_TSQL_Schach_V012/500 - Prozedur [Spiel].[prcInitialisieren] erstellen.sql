...
CREATE OR ALTER PROCEDURE [Spiel].[prcInitialisierung]
	...
	, @ComputerSchritteAnzeigen		AS BIT
AS
BEGIN
	SET NOCOUNT ON;
	...
	INSERT INTO [Spiel].[Konfiguration]
     ...
     VALUES
             ('FALSE'	, @NameWeiss	, @SpielstaerkeWeiss	, @RestzeitWeissInSekunden		, GETDATE(), @ComputerSchritteAnzeigen)
           , ('TRUE'	, @NameSchwarz	, @SpielstaerkeSchwarz	, @RestzeitSchwarzInSekunden	, GETDATE(), @ComputerSchritteAnzeigen)
...
EXECUTE @RC = [Spiel].[prcInitialisierung] 'Peter', 'Sandy', 1, 7, 800, 1200
GO
