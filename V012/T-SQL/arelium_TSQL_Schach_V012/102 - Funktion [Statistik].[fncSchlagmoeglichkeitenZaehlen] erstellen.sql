...
CREATE OR ALTER FUNCTION [Statistik].[fncSchlagmoeglichkeitenZaehlen]
(
	  @IstSpielerWeiss		AS BIT
	, @MoeglicheSchlaege	AS typMoeglicheAktionen READONLY
)
RETURNS INTEGER
AS
BEGIN
...
DECLARE @Skript		VARCHAR(100)	= '102 - Funktion [Statistik].[fncSchlagmoeglichkeitenZaehlen] erstellen.sql'
PRINT ' '
PRINT 'Skript     :   ' + @Skript
PRINT 'Ende       :   ' + @Ende
PRINT 'Zeit       :   ' + @Zeit
...
/*
-- Test der Funktion [Statistik].[fncSchlagmoeglichkeitenZaehlen]
...
SELECT * FROM [Spiel].[fncMoeglicheSchlaege]('TRUE', @ASpielbrett)
SELECT * FROM [Spiel].[fncMoeglicheSchlaege]('FALSE', @ASpielbrett)
GO
*/
