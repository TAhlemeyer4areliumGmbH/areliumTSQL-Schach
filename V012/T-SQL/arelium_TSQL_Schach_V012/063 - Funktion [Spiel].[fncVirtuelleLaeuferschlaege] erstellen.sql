...
-- ###########################################################################################
-- ### Erstellung der Funktion [Spiel].[fncVirtuelleLaeuferschlaege]                       ###
-- ### ----------------------------------------------------------------------------------- ###
-- ### Im Schach gibt es die Fragestellung, ob eine bestimmte Figur (hier der Laeufer) in  ###
...
CREATE OR ALTER FUNCTION [Spiel].[fncVirtuelleLaeuferschlaege]
(
...
DECLARE @Skript		VARCHAR(100)	= '063 - Funktion [Spiel].[fncVirtuelleLaeuferschlaege] erstellen.sql'
PRINT ' '
PRINT 'Skript     :   ' + @Skript
PRINT 'Ende       :   ' + @Ende
PRINT 'Zeit       :   ' + @Zeit
...
GO
/*
-- Test der Funktion [Spiel].[fncVirtuelleLaeuferschlaege]
...
SELECT * FROM [Spiel].[fncVirtuelleLaeuferschlaege](
	'TRUE'
	, @ASpielbrett
	, @AktivesFeld
	, 1)
