...
-- ###########################################################################################
-- ### Die aktuelle Partie aufgeben                                                        ###
-- ### ----------------------------------------------------------------------------------- ###
-- ### Jeder AKTIVE Spieler hat vor jedem Zug die Moeglichkeit, die aktuelle Partie durch  ###
-- ### die eigene Aufgabe zu Gunsten des Gegeners zu beenden.                              ###
-- ###                                                                                     ###
...
CREATE OR ALTER PROCEDURE [Spiel].[prcAktuellesSpielAufgeben]
AS
BEGIN
	SET NOCOUNT ON;
...
DECLARE @Skript		VARCHAR(100)	= '410- Prozedur [Spiel].[prcAktuellesSpielAufgeben] erstellen.sql'
PRINT ' '
PRINT 'Skript     :   ' + @Skript
PRINT 'Ende       :   ' + @Ende
PRINT 'Zeit       :   ' + @Zeit
