...
-- ###########################################################################################
-- ### Erstellung der Funktion [Spiel].[fncMoeglicheDamenaktionen]                         ###
-- ### ----------------------------------------------------------------------------------- ###
...
CREATE OR ALTER FUNCTION [Spiel].[fncMoeglicheDamenaktionen]
(
...
DECLARE @Skript		VARCHAR(100)	= '064 - Funktion [Spiel].[fncMoeglicheDamenaktionen] erstellen.sql'
PRINT ' '
PRINT 'Skript     :   ' + @Skript
PRINT 'Ende       :   ' + @Ende
PRINT 'Zeit       :   ' + @Zeit
...
GO
/*
-- Test der Funktion [Spiel].[fncMoeglicheDamenaktionen]
...
SELECT * FROM [Spiel].[fncMoeglicheDamenaktionen] (
	'TRUE'
	, @ASpielbrett
	, @AktivesFeld)
ORDER BY 2,3,4,5,7
