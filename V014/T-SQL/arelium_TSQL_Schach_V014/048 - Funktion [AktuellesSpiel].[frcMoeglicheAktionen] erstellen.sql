...
CREATE OR ALTER FUNCTION [AktuellesSpiel].[fncMoeglicheAktionen]
(
...
RETURNS @MoeglicheAktionen TABLE 
	...
	BEGIN
		...
		BEGIN 
			...
			(
				[TheoretischeAktionenID], [HalbzugNr], [FigurBuchstabe], [IstSpielerWeiss], [StartSpalte],
			...
			SELECT [TheoretischeAktionenID], 1, [FigurBuchstabe], [IstSpielerWeiss], [StartSpalte],
				[StartReihe], [StartFeld], [ZielSpalte], [ZielReihe], [ZielFeld], [Richtung],
				[UmwandlungsfigurBuchstabe], [ZugIstSchlag], [ZugIstKurzeRochade], [ZugIstLangeRochade],
				[ZugIstEnPassant], [LangeNotation], [KurzeNotationEinfach], [KurzeNotationKomplex] 
			FROM [AktuellesSpiel].[fncMoeglicheDamenaktionen] (@IstSpielerWeiss, @Bewertungsstellung, @Damenfeld)
		...
		BEGIN 
			...
			SELECT [TheoretischeAktionenID], 1, [FigurBuchstabe], [IstSpielerWeiss], [StartSpalte],
				...
				[UmwandlungsfigurBuchstabe], [ZugIstSchlag], [ZugIstKurzeRochade], [ZugIstLangeRochade],
				[ZugIstEnPassant], [LangeNotation], [KurzeNotationEinfach], [KurzeNotationKomplex] 
			FROM [AktuellesSpiel].[fncMoeglicheTurmaktionen] (@IstSpielerWeiss, @Bewertungsstellung, @Turmfeld)
		...
		BEGIN 
			...
			SELECT [TheoretischeAktionenID], 1, [FigurBuchstabe], [IstSpielerWeiss], [StartSpalte],
				...
				[UmwandlungsfigurBuchstabe], [ZugIstSchlag], [ZugIstKurzeRochade], [ZugIstLangeRochade],
				[ZugIstEnPassant], [LangeNotation], [KurzeNotationEinfach], [KurzeNotationKomplex] 
			FROM [AktuellesSpiel].[fncMoeglicheLaeuferaktionen] (@IstSpielerWeiss, @Bewertungsstellung, @Laeuferfeld)
		...
		BEGIN 
			...
			SELECT [TheoretischeAktionenID], 1, [FigurBuchstabe], [IstSpielerWeiss], [StartSpalte],
				...
				[UmwandlungsfigurBuchstabe], [ZugIstSchlag], [ZugIstKurzeRochade], [ZugIstLangeRochade],
				[ZugIstEnPassant], [LangeNotation], [KurzeNotationEinfach], [KurzeNotationKomplex] 
			FROM [AktuellesSpiel].[fncMoeglicheSpringeraktionen] (@IstSpielerWeiss, @Bewertungsstellung, @Springerfeld)
		...
		SELECT [TheoretischeAktionenID], 1, [FigurBuchstabe], [IstSpielerWeiss], [StartSpalte],
			...
			[UmwandlungsfigurBuchstabe], [ZugIstSchlag],	[ZugIstKurzeRochade], [ZugIstLangeRochade],
			[ZugIstEnPassant], [LangeNotation], [KurzeNotationEinfach], [KurzeNotationKomplex]
		FROM [AktuellesSpiel].[fncMoeglicheKoenigsaktionen] (@IstSpielerWeiss, @Bewertungsstellung, @Koenigsfeld)
		...
		BEGIN 
			...
			SELECT [TheoretischeAktionenID], 1, [FigurBuchstabe], [IstSpielerWeiss], [StartSpalte],
				...
				[UmwandlungsfigurBuchstabe], [ZugIstSchlag], [ZugIstKurzeRochade], [ZugIstLangeRochade],
				[ZugIstEnPassant], [LangeNotation], [KurzeNotationEinfach], [KurzeNotationKomplex] 
			FROM [AktuellesSpiel].[fncMoeglicheBauernaktionen] (@IstSpielerWeiss, @Bewertungsstellung, @Bauernfeld)
		...
		-- *** WEISS *****
		-- ***************
		IF (SELECT [IstKurzeRochadeErlaubt] FROM [AktuellesSpiel].[Konfiguration] WHERE [IstSpielerWeiss] = 'TRUE') = 'TRUE'
			OR (SELECT [IstLangeRochadeErlaubt] FROM [AktuellesSpiel].[Konfiguration] WHERE [IstSpielerWeiss] = 'TRUE') = 'TRUE'
		BEGIN
			...
			BEGIN
				...
				-- --------------------------------------------------------------------------------------
				IF (SELECT COUNT(*) FROM [AktuellesSpiel].[Notation] WHERE [LangeNotation] LIKE 'K%' AND [IstSpielerWeiss] = 'TRUE') = 0
				BEGIN
					-- --------------------------------------------------------------------------------------
					...
					IF (SELECT [IstKurzeRochadeErlaubt] FROM [AktuellesSpiel].[Konfiguration] WHERE [IstSpielerWeiss] = @IstSpielerWeiss) = 'TRUE'
					BEGIN
						...
						BEGIN
							...
							-- --------------------------------------------------------------------------------------
							IF (SELECT COUNT(*) FROM [AktuellesSpiel].[Notation] WHERE [LangeNotation] LIKE 'Th1%' AND [IstSpielerWeiss] = 'TRUE') = 0
							BEGIN
							...
							--	-- im "Schach" stehen
							--	-- --------------------------------------------------------------------------------------
							--	IF EXISTS (SELECT * FROM [AktuellesSpiel].[fncVirtuelleSchlaege] ((@IstSpielerWeiss + 1) % 2, @Bewertungsstellung, 33))			-- Feld E1 angegriffen
							--		OR EXISTS (SELECT * FROM [AktuellesSpiel].[fncVirtuelleSchlaege] ((@IstSpielerWeiss + 1) % 2, @Bewertungsstellung, 41))		-- Feld F1 angegriffen
							--		OR EXISTS (SELECT * FROM [AktuellesSpiel].[fncVirtuelleSchlaege] ((@IstSpielerWeiss + 1) % 2, @Bewertungsstellung, 49))		-- Feld G1 angegriffen
							--	BEGIN
					...
					IF (SELECT [IstLangeRochadeErlaubt] FROM [AktuellesSpiel].[Konfiguration] WHERE [IstSpielerWeiss] = @IstSpielerWeiss) = 'TRUE'
					BEGIN
						...
						BEGIN
							...
							-- von dem Ausgangsfeld weg gegeben hat...
							-- --------------------------------------------------------------------------------------
							IF (SELECT COUNT(*) FROM [AktuellesSpiel].[Notation] WHERE [LangeNotation] LIKE 'Ta1%' AND [IstSpielerWeiss] = 'TRUE') > 0
							BEGIN
								-- --------------------------------------------------------------------------------------
								-- eine Rochade ist nur dann moeglich, wenn der Koenig nicht ueber ein gerade angegriffenes
								-- Feld ziehen muss. Alle Felder (seinen aktuellen Standort, das Zielfeld und alle Felder 
								...
								-- im "Schach" stehen
								-- --------------------------------------------------------------------------------------
								IF (SELECT COUNT(*) FROM [AktuellesSpiel].[frcMoeglicheVirtuelleSchlaegeAufFeld] ((@IstSpielerWeiss + 1) % 2, @Bewertungsstellung, 33)) <> 0			-- Feld E1 angegriffen
									OR (SELECT COUNT(*) FROM [AktuellesSpiel].[frcMoeglicheVirtuelleSchlaegeAufFeld] ((@IstSpielerWeiss + 1) % 2, @Bewertungsstellung, 25)) <> 0		-- Feld D1 angegriffen
									OR (SELECT COUNT(*) FROM [AktuellesSpiel].[frcMoeglicheVirtuelleSchlaegeAufFeld] ((@IstSpielerWeiss + 1) % 2, @Bewertungsstellung, 17)) <> 0		-- Feld C1 angegriffen
								BEGIN
		...
		IF (SELECT [IstKurzeRochadeErlaubt] FROM [AktuellesSpiel].[Konfiguration] WHERE [IstSpielerWeiss] = 'FALSE') = 'TRUE'
			OR (SELECT [IstLangeRochadeErlaubt] FROM [AktuellesSpiel].[Konfiguration] WHERE [IstSpielerWeiss] = 'FALSE') = 'TRUE'
		BEGIN
			...
			BEGIN
				...
				-- der Partiehistorie von dem Ausgangsfeld weg gegeben hat...
				-- --------------------------------------------------------------------------------------
				IF (SELECT COUNT(*) FROM [AktuellesSpiel].[Notation] WHERE [LangeNotation] LIKE 'K%' AND [IstSpielerWeiss] = 'FALSE') = 0
				BEGIN
					-- --------------------------------------------------------------------------------------
					-- Eine Rochade ist nur moeglich, wenn der zugehoeriger Turm an der 
					-- "richtigen" Position steht (also auch nicht geschlagen wurden)
					...
					IF (SELECT [IstKurzeRochadeErlaubt] FROM [AktuellesSpiel].[Konfiguration] WHERE [IstSpielerWeiss] = @IstSpielerWeiss) = 'FALSE'
					BEGIN
						...
						BEGIN
							...
							-- von dem Ausgangsfeld weg gegeben hat...
							-- --------------------------------------------------------------------------------------
							IF (SELECT COUNT(*) FROM [AktuellesSpiel].[Notation] WHERE [LangeNotation] LIKE 'Th8%' AND [IstSpielerWeiss] = 'FALSE') = 0
							BEGIN
								-- --------------------------------------------------------------------------------------
								-- eine Rochade ist nur dann moeglich, wenn der Koenig nicht ueber ein gerade angegriffenes
								-- Feld ziehen muss. Alle Felder (seinen aktuellen Standort, das Zielfeld und alle Felder 
								...
								-- im "Schach" stehen
								-- --------------------------------------------------------------------------------------
								IF (SELECT COUNT(*) FROM [AktuellesSpiel].[fncVirtuelleSchlaege] ((@IstSpielerWeiss + 1) % 2, @Bewertungsstellung, 40)) <> 0		-- Feld E8 angegriffen
									OR (SELECT COUNT(*) FROM [AktuellesSpiel].[fncVirtuelleSchlaege] ((@IstSpielerWeiss + 1) % 2, @Bewertungsstellung, 48)) <> 0	-- Feld F8 angegriffen
									OR (SELECT COUNT(*) FROM [AktuellesSpiel].[fncVirtuelleSchlaege] ((@IstSpielerWeiss + 1) % 2, @Bewertungsstellung, 56)) <> 0	-- Feld G8 angegriffen
								BEGIN
					...
					IF (SELECT [IstLangeRochadeErlaubt] FROM [AktuellesSpiel].[Konfiguration] WHERE [IstSpielerWeiss] = @IstSpielerWeiss) = 'FALSE'
					BEGIN
						...
						BEGIN
							...
							-- von dem Ausgangsfeld weg gegeben hat...
							-- --------------------------------------------------------------------------------------
							IF (SELECT COUNT(*) FROM [AktuellesSpiel].[Notation] WHERE [LangeNotation] LIKE 'Ta8%' AND [IstSpielerWeiss] = 'FALSE') > 0
							BEGIN
								-- --------------------------------------------------------------------------------------
								-- eine Rochade ist nur dann moeglich, wenn der Koenig nicht ueber ein gerade angegriffenes
								-- Feld ziehen muss. Alle Felder (seinen aktuellen Standort, das Zielfeld und alle Felder 
								...
								-- im "Schach" stehen
								-- --------------------------------------------------------------------------------------
								IF EXISTS (SELECT * FROM [AktuellesSpiel].[frcMoeglicheVirtuelleSchlaegeAufFeld] ((@IstSpielerWeiss + 1) % 2, @Bewertungsstellung, 40))			-- Feld E8 angegriffen
									OR EXISTS (SELECT * FROM [AktuellesSpiel].[frcMoeglicheVirtuelleSchlaegeAufFeld] ((@IstSpielerWeiss + 1) % 2, @Bewertungsstellung, 32))		-- Feld D8 angegriffen
									OR EXISTS (SELECT * FROM [AktuellesSpiel].[frcMoeglicheVirtuelleSchlaegeAufFeld] ((@IstSpielerWeiss + 1) % 2, @Bewertungsstellung, 24))		-- Feld C8 angegriffen
								BEGIN
		...
		--	AND (
		--			[AktuellesSpiel].[fncIstFeldBedroht]([IstSpielerWeiss], @Bewertungsstellung, 24) = 'TRUE'
		--			OR
		--			[AktuellesSpiel].[fncIstFeldBedroht]([IstSpielerWeiss], @Bewertungsstellung, 32) = 'TRUE'
		--		)
...
DECLARE @Skript		VARCHAR(100)	= '048 - Funktion [AktuellesSpiel].[fncMoeglicheAktionen] erstellen.sql'
PRINT ' '
PRINT 'Skript     :   ' + @Skript
PRINT 'Ende       :   ' + @Ende
PRINT 'Zeit       :   ' + @Zeit
...
/*
-- Test der Funktion [AktuellesSpiel].[fncMoeglicheAktionen]
...
SELECT * FROM [AktuellesSpiel].[fncMoeglicheAktionen]('FALSE', @Bewertungsstellung)
