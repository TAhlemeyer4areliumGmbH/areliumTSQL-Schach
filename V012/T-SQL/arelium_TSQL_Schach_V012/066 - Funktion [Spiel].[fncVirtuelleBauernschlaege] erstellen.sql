...
-- ###########################################################################################
-- ### Erstellung der Funktion [Spiel].[fncVirtuelleBauernschlaege]                        ###
-- ### ----------------------------------------------------------------------------------- ###
-- ### Im Schach gibt es die Fragestellung, ob eine bestimmte Figur (hier der Bauer) in    ###
...
CREATE OR ALTER FUNCTION [Spiel].[fncVirtuelleBauernschlaege]
(
...
RETURNS @VirtuelleBauernschlaege TABLE 
	(
	...
	BEGIN
		INSERT INTO @VirtuelleBauernschlaege
		(
...
DECLARE @Skript		VARCHAR(100)	= '066 - Funktion [Spiel].[fncVirtuelleBauernschlaege] erstellen.sql'
PRINT ' '
PRINT 'Skript     :   ' + @Skript
PRINT 'Ende       :   ' + @Ende
PRINT 'Zeit       :   ' + @Zeit
...
/*
-- Test der Funktion [Spiel].[fncVirtuelleBauernschlaege]
...
SELECT * FROM [Spiel].[fncVirtuelleBauernschlaege] (
	'True'
	, @ASpielbrett
	, @AktivesFeld
	, 33)
