...
-- ###########################################################################################
-- ### Erstellung der Funktion [Spiel].[fncMoeglicheKoenigsaktionen]                       ###
-- ### ----------------------------------------------------------------------------------- ###
...
CREATE OR ALTER FUNCTION [Spiel].[fncMoeglicheKoenigsaktionen]
(
...
DECLARE @Skript		VARCHAR(100)	= '065 - Funktion [Spiel].[fncMoeglicheKoenigsaktionen] erstellen.sql'
PRINT ' '
PRINT 'Skript     :   ' + @Skript
PRINT 'Ende       :   ' + @Ende
PRINT 'Zeit       :   ' + @Zeit
...
/*
-- Test der Funktion [Spiel].[fncMoeglicheKoenigsaktionen]
...
SELECT * FROM [Spiel].[fncMoeglicheKoenigsaktionen] (
	'True'
	, @ASpielbrett
	, @AktivesFeld)
ORDER BY 2,3,4,5,7
