	...
	BEGIN
		...
		BEGIN 
			...
			SELECT [TheoretischeAktionenID], 1, [FigurName], [IstSpielerWeiss], [StartSpalte],
				...
				[UmwandlungsfigurBuchstabe], [ZugIstSchlag], [ZugIstKurzeRochade], [ZugIstLangeRochade],
				[ZugIstEnPassant], [LangeNotation], [KurzeNotationEinfach], [KurzeNotationKomplex] 
			FROM [Spiel].[fncMoeglicheTurmschlaege] (
		...
		BEGIN 
			...
			SELECT [TheoretischeAktionenID], 1, [FigurName], [IstSpielerWeiss], [StartSpalte],
				...
				[UmwandlungsfigurBuchstabe], [ZugIstSchlag], [ZugIstKurzeRochade], [ZugIstLangeRochade],
				[ZugIstEnPassant], [LangeNotation], [KurzeNotationEinfach], [KurzeNotationKomplex] 
			FROM [Spiel].[fncMoeglicheLaeuferschlaege] (
															(	SELECT [IstSpielerWeiss] 
																FROM @Bewertungsstellung 
																WHERE 1 = 1
		...
		BEGIN 
			...
			SELECT [TheoretischeAktionenID], 1, [FigurName], [IstSpielerWeiss], [StartSpalte],
				...
				[UmwandlungsfigurBuchstabe], [ZugIstSchlag], [ZugIstKurzeRochade], [ZugIstLangeRochade],
				[ZugIstEnPassant], [LangeNotation], [KurzeNotationEinfach], [KurzeNotationKomplex] 
			FROM [Spiel].[fncMoeglicheSpringerschlaege] (
															(	SELECT [IstSpielerWeiss] 
																FROM @Bewertungsstellung 
																WHERE 1 = 1
		...
		BEGIN 
			...
			SELECT [TheoretischeAktionenID], 1, [FigurName], [IstSpielerWeiss], [StartSpalte],
				...
				[UmwandlungsfigurBuchstabe], [ZugIstSchlag], [ZugIstKurzeRochade], [ZugIstLangeRochade],
				[ZugIstEnPassant], [LangeNotation], [KurzeNotationEinfach], [KurzeNotationKomplex] 
			FROM [Spiel].[fncMoeglicheBauernschlaege] (
															(	SELECT [IstSpielerWeiss] 
																FROM @Bewertungsstellung 
																WHERE 1 = 1
																	AND [Feld]		= @Bauernfeld)
...
DECLARE @Skript		VARCHAR(100)	= '081 - Funktion [Spiel].[fncMoeglicheSchlaege] erstellen.sql'
PRINT ' '
PRINT 'Skript     :   ' + @Skript
PRINT 'Ende       :   ' + @Ende
PRINT 'Zeit       :   ' + @Zeit
