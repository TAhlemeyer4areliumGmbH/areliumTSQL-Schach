...
-- ###########################################################################################
-- ### Erstellung der Funktion [Spiel].[fncMoeglicheSpringeraktionen]                      ###
-- ### ----------------------------------------------------------------------------------- ###
...
-- Aufbauarbeiten -----------
-----------------------------
CREATE OR ALTER FUNCTION [Spiel].[fncMoeglicheSpringeraktionen]
(
...
DECLARE @Skript		VARCHAR(100)	= '042 - Funktion [Spiel].[fncMoeglicheSpringeraktionen] erstellen.sql'
PRINT ' '
PRINT 'Skript     :   ' + @Skript
PRINT 'Ende       :   ' + @Ende
PRINT 'Zeit       :   ' + @Zeit
...
/*
-- Test der Funktion [Spiel].[fncMoeglicheSpringeraktionen]
...
SELECT * FROM [Spiel].[fncMoeglicheSpringeraktionen] (
	'True'
	, @ASpielbrett
	, @AktivesFeld)
ORDER BY 2,3,4,5,7
