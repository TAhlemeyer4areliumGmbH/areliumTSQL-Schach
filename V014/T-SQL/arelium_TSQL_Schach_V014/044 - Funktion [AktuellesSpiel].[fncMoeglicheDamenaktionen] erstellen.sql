...
-- ###########################################################################################
-- ### Erstellung der Funktion [AktuellesSpiel].[fncMoeglicheDamenaktionen]                         ###
-- ### ----------------------------------------------------------------------------------- ###
-- ### Moechte man herausfinden, welche Moeglichkeiten man in einer bestimmten Stellung    ###
-- ### hat die Figur "Dame" zu ziehen, bemueht man diese Funktion. Sie erwartet die        ###
...
CREATE OR ALTER FUNCTION [AktuellesSpiel].[fncMoeglicheDamenaktionen]
(
...
DECLARE @Skript		VARCHAR(100)	= '044 - Funktion [AktuellesSpiel].[fncMoeglicheDamenaktionen] erstellen.sql'
PRINT ' '
PRINT 'Skript     :   ' + @Skript
PRINT 'Ende       :   ' + @Ende
PRINT 'Zeit       :   ' + @Zeit
...
GO
/*
-- Test der Funktion [AktuellesSpiel].[fncMoeglicheDamenaktionen]
...
SELECT * FROM [AktuellesSpiel].[fncMoeglicheDamenaktionen] (
	'TRUE'
	, @ASpielbrett
	, @AktivesFeld)
ORDER BY 2,3,4,5,7
