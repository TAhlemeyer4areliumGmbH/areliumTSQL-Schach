...
-- ### Beispielaufgabe 001                                                                 ###
-- ### ----------------------------------------------------------------------------------- ###
-- ### Dieses Skript stellt eine "matt in zwei Zuegen"-Aufgabe. Dazu wird eine Stellung    ###
-- ### aufgebaut. Weiss hat das Zugrecht. Zum Aufbau wird das EFN-Protokoll genutzt.       ###
-- ###                                                                                     ###
-- ### Ueber den Befehl <EXECUTE [Spiel].[prcMatt_in_x_Zuegen] 2> wird der Rechner gebeten ###
-- ### diese Stellung zu analysieren und das Matt zu finden.                               ###
-- ### ----------------------------------------------------------------------------------- ###
-- ### Sicherheitshinweis:                                                                 ###
...
-- Die Aufgabe initialisieren
DECLARE @EFN varchar(255)
SET @EFN = '8/2k2N1Q/1N6/1K6/8/8/8/8 w - - 1 1'
