...
-- ###########################################################################################
-- ### Erstellung der Funktion [Statistik].[fncBauernvormarsch]                            ###
-- ### ----------------------------------------------------------------------------------- ###
...
-- ### ist die Frage, wie weit er schon auf seinem Weg zur gegnerischen Grundlinie         ###
-- ### vorangeschritten ist. Je weiter er schon vorgerueckt ist, je naeher ist er an der   ###
-- ### Bauernumwandlung und kann sich bspw. in eine Dame verwandeln.                       ###
-- ###                                                                                     ###
...
CREATE OR ALTER FUNCTION [Statistik].[fncBauernvormarsch]
(
...
DECLARE @Skript		VARCHAR(100)	= '104 - Funktion [Statistik].[fncBauernvormarsch] erstellen.sql'
PRINT ' '
PRINT 'Skript     :   ' + @Skript
PRINT 'Ende       :   ' + @Ende
PRINT 'Zeit       :   ' + @Zeit
...
/*
-- Test der Funktion 104 - Funktion [Statistik].[fncBauernvormarsch] erstellen
...
SELECT [Statistik].[fncBauernvormarsch]('TRUE', @ASpielbrett)
SELECT [Statistik].[fncBauernvormarsch]('FALSE', @ASpielbrett)
GO
*/
