...
EXECUTE [Spiel].[prcInitialisierung] 
  ...
  ,@SpielstaerkeSchwarz				= 7			-- Computergegner, Spielstufe "Weltmeisterin"
...
-- Es zieht SCHWARZ den ersten Zug -> Bauer von Sb8 nach c6
EXECUTE [Spiel].[prcZugAusfuehren] 
		  @Startquadrat				= 'b8'
		, @Zielquadrat				= 'c6'
		, @Umwandlungsfigur			= NULL
...
-- Vollzug 009
EXECUTE [Spiel].[prcZugAusfuehren] 'f1', 'e1', NULL, 'FALSE', 'TRUE'			
GO																				
...
GO																				
EXECUTE [Spiel].[prcZugAusfuehren] 'a8', 'b8', NULL, 'FALSE', 'FALSE'
GO	
