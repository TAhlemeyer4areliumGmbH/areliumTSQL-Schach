...
-- ###########################################################################################
-- ### Erstellung der Funktion [Spiel].[fncMoeglicheBauernschlaege]                        ###
-- ### ----------------------------------------------------------------------------------- ###
-- ### Moechte man herausfinden, welche Moeglichkeiten man in einer bestimmten Stellung    ###
-- ### hat mit der Figur "Bauer" zu schlagen, bemueht man diese Funktion. Sie erwartet die ###
-- ### Angabe einer Stellung (dies muss nicht zwingend [Infrastruktur].[Spielbrett] sein!) ###
-- ### und des Feldes, fuer den die Schlagmoeglichkeiten abgefragt werden sollen. So sind  ###
-- ### Aussagen zu beliebigen Stellungen denkbar.                                          ###
-- ###                                                                                     ###
...
CREATE OR ALTER FUNCTION [Spiel].[fncMoeglicheBauernschlaege]
(
	   @IstSpielerWeiss		AS BIT
	 , @Bewertungsstellung	AS typStellung			READONLY
	 , @AktivesFeld			AS INTEGER
)
RETURNS @MoeglicheBauernschlaege TABLE 
	(
	...
	BEGIN
		INSERT INTO @MoeglicheBauernschlaege
		(
...
DECLARE @Skript		VARCHAR(100)	= '076 - Funktion [Spiel].[fncMoeglicheBauernschlaege] erstellen.sql'
PRINT ' '
PRINT 'Skript     :   ' + @Skript
PRINT 'Ende       :   ' + @Ende
PRINT 'Zeit       :   ' + @Zeit
...
/*
-- Test der Funktion [Spiel].[fncMoeglicheBauernschlaege]
...
SELECT * FROM [Spiel].[fncMoeglicheBauernschlaege] (
	'True'
	, @ASpielbrett
	, @AktivesFeld)
ORDER BY 2,3,4,5,7
