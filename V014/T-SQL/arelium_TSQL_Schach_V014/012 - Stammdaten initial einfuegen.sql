...
DELETE FROM [Infrastruktur].[Figuren]
GO

INSERT INTO [Infrastruktur].[Figuren] ([FigurUTF8], [IstSpielerWeiss], [FigurName], [FigurBuchstabe], [FigurSymbol], [FigurWert], [FigurInternational])
     VALUES (9812, 'TRUE',  'Koenig',			'K',		NCHAR(9812),  0, 'K')
	 ,		(9813, 'TRUE',  'Dame',				'D',		NCHAR(9813), 10, 'Q')
	 ,		(9815, 'TRUE',  'Laeufer',			'L',		NCHAR(9815),  3, 'B')
	 ,		(9816, 'TRUE',  'Springer',			'S',		NCHAR(9816),  3, 'N')
	 ,		(9814, 'TRUE',  'Turm',				'T',		NCHAR(9814),  5, 'R')
	 ,		(9817, 'TRUE',  'Bauer',			'B',		NCHAR(9817),  1, 'P')
	 ,		( 160, NULL,	'unbelegtes Feld',	CHAR(160),	NCHAR(160) ,  0, CHAR(160))
     ,		(9818, 'FALSE', 'Koenig',			'K',		NCHAR(9818),  0, 'k')
	 ,		(9819, 'FALSE', 'Dame',				'D',		NCHAR(9819), 10, 'q')
	 ,		(9821, 'FALSE', 'Laeufer',			'L',		NCHAR(9821),  3, 'b')
	 ,		(9822, 'FALSE', 'Springer',			'S',		NCHAR(9822),  3, 'n')
	 ,		(9820, 'FALSE', 'Turm',				'T',		NCHAR(9820),  5, 'r')
	 ,		(9823, 'FALSE', 'Bauer',			'B',		NCHAR(9823),  1, 'p')
GO
...
DELETE FROM [Infrastruktur].[Spielstaerke]
GO
...
INSERT INTO [Statistik].[Stellungsbewertung]
     ...
     VALUES
		   ...
		   , (  8,  'Gesamtbewertung:'		,    0,  0, 'posive Werte bedeuten ein Vorteil fuer Weiss, negative fuer Schwarz')
GO
