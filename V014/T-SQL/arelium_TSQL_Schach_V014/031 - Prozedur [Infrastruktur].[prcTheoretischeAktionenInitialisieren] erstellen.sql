...
BEGIN
	...
	INSERT INTO [Infrastruktur].[TheoretischeAktionen] 
		(     [FigurBuchstabe], [IstSpielerWeiss], [StartSpalte], [StartReihe], [Startfeld]
	...
	-- beliebig weit diagonal, waagerecht oder senkrecht ziehen und schlagen
		...
		INSERT INTO [Infrastruktur].[TheoretischeAktionen] ([FigurBuchstabe], [IstSpielerWeiss], [StartSpalte], [StartReihe], 
	...
	-- bewegen: Er kann diagonal, waagerecht oder senkrecht ziehen und schlagen
		...
		INSERT INTO [Infrastruktur].[TheoretischeAktionen] ([FigurBuchstabe], [IstSpielerWeiss], [StartSpalte]
	...
	-- die Rochade korrekt nach langer/kurzer Notation protokolliert wird!
		...
		INSERT INTO [Infrastruktur].[TheoretischeAktionen] ([FigurBuchstabe], [IstSpielerWeiss], [StartSpalte], [StartReihe], [StartFeld]
		...
		-- kurze Rochade weiss
		VALUES	  ('K', 'TRUE',  'E', 1, 33, 'G', 1, 49, 'RE', NULL, 'FALSE', 'TRUE', 'FALSE', 'FALSE', 'o-o',		'o-o',		'o-o')
		-- lange Rochade weiss
				, ('K', 'TRUE',  'E', 1, 33, 'C', 1, 17, 'LI', NULL, 'FALSE', 'FALSE', 'TRUE', 'FALSE', 'o-o-o',	'o-o-o',	'o-o-o')
		-- kurze Rochade schwarz
				, ('K', 'FALSE', 'E', 8, 40, 'G', 8, 56, 'RE', NULL, 'FALSE', 'TRUE', 'FALSE', 'FALSE', 'o-o',		'o-o',		'o-o')
		-- lange Rochade schwarz
				, ('K', 'FALSE', 'E', 8, 40, 'C', 8, 24, 'LI', NULL, 'FALSE', 'FALSE', 'TRUE', 'FALSE', 'o-o-o',	'o-o-o',	'o-o-o')
	...
	-- ziehen
	INSERT INTO [Infrastruktur].[TheoretischeAktionen] 
													([FigurBuchstabe], [IstSpielerWeiss], [StartSpalte]
													, [StartReihe], [StartFeld], [ZielSpalte], [ZielReihe], [ZielFeld]
													, [Richtung], [UmwandlungsfigurBuchstabe], [ZugIstSchlag]
													, [ZugIstKurzeRochade], [ZugIstLangeRochade]
													, [ZugIstEnPassant], [LangeNotation], [KurzeNotationEinfach], [KurzeNotationKomplex])
...
DECLARE @Skript		VARCHAR(100)	= '031 - Prozedur [Infrastruktur].[prcTheoretischeAktionenInitialisieren] erstellen.sql'
PRINT ' '
PRINT 'Skript     :   ' + @Skript
PRINT 'Ende       :   ' + @Ende
PRINT 'Zeit       :   ' + @Zeit
