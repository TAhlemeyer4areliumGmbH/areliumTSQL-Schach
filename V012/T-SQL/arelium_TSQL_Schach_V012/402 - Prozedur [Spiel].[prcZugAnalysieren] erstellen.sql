...
-- ###########################################################################################
-- ### Erstellung der Prozedur [Spiel].[prcZugAnalysieren]                                 ###
-- ### ----------------------------------------------------------------------------------- ###
...
-- Erstellung der Prozedur [Spiel].[prcZugAnalysieren]
-- -----------------------------------------------------------------------------------------
CREATE OR ALTER PROCEDURE [Spiel].[prcZugAnalysieren]
(
...
BEGIN
	...
	SELECT 
		1 AS [VarianteNr], 1 AS [Suchtiefe], [Spalte], [Reihe], [Feld], [IstSpielerWeiss], [FigurBuchstabe], [FigurUTF8]
	FROM @Folgestellung
END
GO
...
DECLARE @Skript		VARCHAR(100)	= '402 - Prozedur [Spiel].[prcZugAnalysieren] erstellen.sql'
PRINT ' '
PRINT 'Skript     :   ' + @Skript
PRINT 'Ende       :   ' + @Ende
PRINT 'Zeit       :   ' + @Zeit
...
/*
-- Test der Funktion [Spiel].[prcZugAnalysieren]
USE [arelium_TSQL_Schach_V012]
GO
...
SET @TheoretischeAktionID = 484372  -- Springer b1 nach c3

EXECUTE [Spiel].[prcZugAnalysieren] 
   @ASpielbrett
