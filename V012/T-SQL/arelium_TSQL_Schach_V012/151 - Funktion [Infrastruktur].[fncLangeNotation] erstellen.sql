...
-- ###########################################################################################
-- ### Erstellung der Funktion [Infrastruktur].[fncLangeNotation]                          ###
-- ### ----------------------------------------------------------------------------------- ###
-- ### Diese Funktion wandelt einen Zug dieses T-SQL-Algorithmus in die standardisierte    ###
-- ### Beschreibung eines Zuges in der Schachwelt um: die lange Notation.                  ###
-- ### (Es gibt auch eine kurze Notation, bei der redundante Angaben weggelassen werden)   ###
-- ###                                                                                     ###
-- ### Dabei gilt:                                                                         ###
...
-- ###    - Angeben wird stets die Figur (außer beim Bauern!), gefolgt vom Startfeld, dann ###
-- ###      das Zeichen fuer Zug oder Schlag und schliesslich dem Zielfeld                 ###
...
-- ### ----------------------------------------------------------------------------------- ###
-- ### Beispiele:                                                                          ###
-- ###    - 11. Te4xe7+              --> bedeutet, dass der weisse Turm im 11. Zug vom     ###
-- ###                                   Feld E4 zieht, die Figur auf E7 schlaegt und      ###
-- ###                                   dabei Schach gibt.                                ###
-- ###    - 11.          b7-b5       --> bedeutet, dass der schwarze Bauer im 11. Zug vom  ###
-- ###                                   Feld B7 einen Doppelschritt nach B5 macht.        ###
-- ### ----------------------------------------------------------------------------------- ###
-- ### Sicherheitshinweis:                                                                 ###
...
CREATE OR ALTER FUNCTION [Infrastruktur].[fncLangeNotation]
(
...
DECLARE @Skript		VARCHAR(100)	= '151 - Funktion [Infrastruktur].[fncLangeNotation] erstellen.sql'
PRINT ' '
PRINT 'Skript     :   ' + @Skript
PRINT 'Ende       :   ' + @Ende
PRINT 'Zeit       :   ' + @Zeit
...
GO
/*
-- Test der Funktion [Infrastruktur].[fncLangeNotation] 

SELECT [Infrastruktur].[fncLangeNotation] (13879, 'TRUE', 'FALSE')
GO
*/
